...
void get_factors(float dt, float *factors, bool calculate){
    /*
    Writes integration factors for time interval dt to factors. If calculate is true the calc_factors are calculated
